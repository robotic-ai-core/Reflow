...
"""
        ...
        env_vars, config_files = EnvironmentManager.extract_environment_from_configs([config1_path, config2_path])
    ...
    def test_nonexistent_config_file_handling(self, tmp_path):
        ...
        env_vars, config_files = EnvironmentManager.extract_environment_from_configs([nonexistent_path])
        assert isinstance(env_vars, dict)
        assert len(env_vars) == 0
...
"""
        ...
        env_vars, config_files = EnvironmentManager.extract_environment_from_configs([invalid_path])
        assert isinstance(env_vars, dict)
    ...
    def test_permission_denied_file_access(self, tmp_path):
        ...
        try:
            ...
            env_vars, config_files = EnvironmentManager.extract_environment_from_configs([restricted_file])
            assert isinstance(env_vars, dict)
