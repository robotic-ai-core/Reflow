"""Resume training-state continuity tests.

Exercises end-to-end fit → checkpoint → resume cycles and asserts that
training progresses correctly (steps, optimizer state, data ordering,
multi-stage chains).
"""
